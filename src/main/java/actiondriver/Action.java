...
public class Action extends BuildersRiskBaseClass{
...
*/
	...
	/*
		public static screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/IsiAutomationProject/ws/IsiAutomationProject/ScreenShots/" + filename + "_"
				+ dateName + ".png";
