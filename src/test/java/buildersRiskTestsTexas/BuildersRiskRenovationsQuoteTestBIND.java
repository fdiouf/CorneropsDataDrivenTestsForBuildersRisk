package buildersRiskTestsTexas;                                                                     // THIS TEST RUNS FOR 3 MINUTES AND 49 SECONDS
...
public class BuildersRiskRenovationsQuoteTestBIND extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("TXRenovationsPolicyDataBIND");
		int totalcols = xlutil.getCellCount("TXRenovationsPolicyDataBIND", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("TXRenovationsPolicyDataBIND", i, j);
			}
		}
		return loginData;
	}
...
//		buildercounty.selectByVisibleText(builderscounty);
		...
		driver.findElement(By.id(loc.getProperty("buildershailscore"))).click();
		driver.findElement(By.id(loc.getProperty("buildershailscore"))).sendKeys(buildershailscore);
		driver.findElement(By.id(loc.getProperty("buildershailscore"))).click();
		driver.findElement(By.xpath(loc.getProperty("builderstier"))).click();
		driver.findElement(By.xpath(loc.getProperty("builderstier"))).sendKeys(builderstier);
		driver.findElement(By.xpath(loc.getProperty("builderstier"))).click();
