package buildersRiskTestsTexas;                                                                     // THIS TEST RUNS FOR 9 MINUTES AND 29 SECONDS
...
public class BuildersRiskNewConstructionQuoteTestBind extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("TXNewConstructionPolicyDataBIND");
		int totalcols = xlutil.getCellCount("TXNewConstructionPolicyDataBIND", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("TXNewConstructionPolicyDataBIND", i, j);
			}
		}
		return loginData;
	}
	...
	public void buildersRiskNewPolicy(String newquotestate, String newquotepolicytype, String newquoteaddress, String newquoteaddress2, 
		...
		if(!builderssquarefootage.equals("")) {
			...
			driver.findElement(By.id(loc.getProperty("builderssquarefootage"))).sendKeys("1000");
		}
...
//		driver.findElement(By.id(loc.getProperty("buildersexperiencedyes"))).click();
		...
		if(builderssecuritypoints.equals("")) {
			...
			points = Integer.parseInt(builderssecuritypoints);
		}
		if(points >= 105) {
