package buildersRiskTestsTexas;                                                                     // THIS TEST RUNS FOR 3 MINUTES AND 31 SECONDS
...
public class BuildersRiskNewConstructionQuoteTestNoBind extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("TXNewConstructionPolicyDataNB");
		int totalcols = xlutil.getCellCount("TXNewConstructionPolicyDataNB", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("TXNewConstructionPolicyDataNB", i, j);
			}
		}
		return loginData;
	}
