package buildersRiskTestsTexas;                                                                     // THIS TEST RUNS FOR 4 MINUTES AND 14 SECONDS
...
public class BuildersRiskNewConstructionQuoteTestBindAfterJuly30 extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("TXNewConstructionPolicyDataAJ30");
		int totalcols = xlutil.getCellCount("TXNewConstructionPolicyDataAJ30", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("TXNewConstructionPolicyDataAJ30", i, j);
			}
		}
		return loginData;
	}
	...
	public void buildersRiskNewPolicy(String newquotestate, String newquotepolicytype, String newquoteaddress, String newquoteaddress2, 
			...
			String buildersjudgementrate, String buildersjudgementreason) throws InterruptedException, ParseException {
...
//		buildercounty.selectByVisibleText(builderscounty);
		...
		if(buildersfirehydrant.equals("")){
			...
			driver.findElement(By.id(loc.getProperty("buildersfirehydrant"))).click();
			driver.findElement(By.id(loc.getProperty("buildersfirehydrant"))).sendKeys("Less than 1000 feet");
...
if(builderssquarefootage.equals("")){
			
			driver.findElement(By.id(loc.getProperty("builderssquarefootage"))).click();
			driver.findElement(By.id(loc.getProperty("builderssquarefootage"))).sendKeys("15000");
...
//		driver.findElement(By.id(loc.getProperty("buildersexperiencedyes"))).click();
		...
		if(builderscrimescore.equals("")) {
			builderscrimescore = driver.findElement(By.id(loc.getProperty("builderscrimescore"))).getAttribute("value");
			Thread.sleep(500);
		}
		else {
