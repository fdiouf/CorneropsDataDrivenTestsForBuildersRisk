package buildersRiskTestsFlorida;														// THIS TEST RUNS FOR 3 MINUTES AND 38 SECONDS
...
public class BuildersRiskRenovationsQuoteTestBind extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("FLRenovationsPolicyDataBIND");
		int totalcols = xlutil.getCellCount("FLRenovationsPolicyDataBIND", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("FLRenovationsPolicyDataBIND", i, j);
			}
		}
		return loginData;
	}
	...
	public void buildersRiskNewQuote(String newquotestate, String newquotepolicytype, String newquoteaddress, String newquoteaddress2, 
			...
			String buildersbusinessname, String buildersdbaname, String buildersstructure, String buildersmailingaddress, 
			String buildersmailingaddress2, String buildersmailingcity, String buildersmailingstate, String buildersmailingzip, 
			String buildersmailingzip4, String builderslocationzip4, String builderscounty, String builderscoastdistance, 
			String builderscoastdistanceunit, String builderswindpool, String buildersterritory, String builderssinkholedistance, 
			String builderssinkholedistanceunits, String buildersprotectionclass, String buildersfirestation, String buildersfirehydrant, 
			String builderscoveragerequired, String buildersstructurevalue, String buildersworkvalue, String buildersdeductible, 
			String builderswindhaildeductible, String buildersconstructioncostlimit, String builderspropertytransitlimit, 
			String builderssoftcostlimit, String buildersstructuretype, String buildersconstructionyear, String builderselectricalyear, 
			String buildersroofingyear, String buildersplumbingyear, String buildershvacyear, String builderssquarefootage,  String buildersroofmaterial,
			String buildersconstructiontype, String builderspriorinscarrier, String buildersnumberofstories, String builderspriorinsenddate, 
			String builderspriorinspremium, String buildersinteresttype, String buildersinterestname, String buildersinterestaddress, 
			String buildersinterestaddress2, String buildersinterestcity, String buildersintereststate, String buildersinterestzip, 
			String buildersinterestzip4, String buildersloannumber, String builderstinsuredtype, String builderstinsuredfirstname, 
			String builderstinsuredmiddlename, String builderstinsuredlastname, String builderstinsuredaddress, String builderstinsuredaddress2, 
			String builderstinsuredcity, String builderstinsuredstate, String builderstinsuredzip, String builderslegalname, 
...
//		buildercounty.selectByVisibleText(builderscounty);
		...
		driver.findElement(By.id(loc.getProperty("builderswindpool"))).click();
		driver.findElement(By.id(loc.getProperty("builderswindpool"))).sendKeys("Out");// DEFECT 6996 ---------------------------------------------------->
		...
		if(!builderscoastdistanceunit.equals("")) {
			driver.findElement(By.id(loc.getProperty("builderscoastdistanceunit"))).click();
			driver.findElement(By.id(loc.getProperty("builderscoastdistanceunit"))).clear();
		...
		if(!builderssinkholedistance.equals("")) {
		...
		if(!builderssinkholedistanceunits.equals("")) {
			driver.findElement(By.id(loc.getProperty("builderssinkholedistanceunits"))).click();
			driver.findElement(By.id(loc.getProperty("builderssinkholedistanceunits"))).clear();
		...
		driver.findElement(By.id(loc.getProperty("buildersfirehydrant"))).click();
		driver.findElement(By.id(loc.getProperty("buildersfirehydrant"))).sendKeys("L");// idk ------------------------------------>
		...
		if(buildersstructuretype.equalsIgnoreCase("Other")) {
			...
			driver.findElement(By.id(loc.getProperty("buildersstructuredesc"))).clear();
