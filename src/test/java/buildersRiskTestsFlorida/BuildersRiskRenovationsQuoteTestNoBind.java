package buildersRiskTestsFlorida;														// THIS TEST RUNS FOR 3 MINUTES AND 27 SECONDS
...
public class BuildersRiskRenovationsQuoteTestNoBind extends BuildersRiskBaseClass {
	...
	public String[][] getData() throws IOException {
		...
		int totalrows = xlutil.getRowCount("FLRenovationsPolicyDataNB");
		int totalcols = xlutil.getCellCount("FLRenovationsPolicyDataNB", 1);

		String loginData[][] = new String[totalrows][totalcols];

		for (int i = 1; i <= totalrows; i++) {
			for (int j = 0; j < totalcols; j++) {
				loginData[i - 1][j] = xlutil.getCellData("FLRenovationsPolicyDataNB", i, j);
			}
		}
		return loginData;
	}
