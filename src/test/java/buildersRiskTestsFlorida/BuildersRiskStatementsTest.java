package buildersRiskTestsFlorida;														// THIS TEST RUNS FOR 2 MINUTES AND 30 SECONDS
...
public class BuildersRiskStatementsTest extends BuildersRiskBaseClass {
	...
	public void buildersRiskHistory1(String newquotestate, String newquotepolicytype,
	...
	public void buildersRiskStatements2(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
	...
	public void buildersRiskStatements3(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
		...
		if (buildersconstructionstarted.equalsIgnoreCase("Yes")) {
			...
			driver.findElement(By.id(loc.getProperty("buildersconstructionstarted"))).click();
			driver.findElement(By.id(loc.getProperty("buildersconstructionstarted"))).click();
			driver.findElement(By.id(loc.getProperty("builderspercentcomplete"))).click();if(!driver.findElement(By.id(loc.getProperty("builderspercentcomplete"))).getAttribute("maxvalue").equals("100")) {
	...
	@Test(dataProvider = "NewConstructionData", description = "T18846	TC04 - Builders Risk - Statements - Security Information section", enabled = true, priority = 4)
	public void buildersRiskStatements4(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
		...
		if(builderscrimescore.equalsIgnoreCase("D") || builderscrimescore.equalsIgnoreCase("E") || builderscrimescore.equalsIgnoreCase("F")) {
			...
			try {
				...
				abc = false;
				System.out.print("\nCrime Score questions are working as expected");
			}
			if(abc == true) {
				Assert.fail("EXPECTED SECURITY QUESTIONS TO BE HIDDEN IF CRIME SCORE WAS NOT 'D', 'E', OR 'F'");
			}
		}
		System.out.print("\nCrime Score security questions are working as expected");
		driver.findElement(By.id(loc.getProperty("builderscrimetext"))).click();
		if(!driver.findElement(By.id(loc.getProperty("builderscrimetext"))).getAttribute("maxlength").equals("500")) {
			Assert.fail("EXPECTED CRIME TEXT TO HAVE A MAX LENGTH OF 500");
		}
		...
		try {
			...
			Assert.fail("ERROR WHILE TRYING TO PROCESS TO INTERNAL TAB");
		}
