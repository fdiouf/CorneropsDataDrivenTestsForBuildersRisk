package buildersRiskTXAgentTests;                                                                     // THIS TEST RUNS FOR 1 MINUTES AND 47 SECONDS
...
public class AgentCoverageTest extends BuildersRiskBaseClass {
	...
	@Test(dataProvider = "NewConstructionData", description = "T18806	TC04 - Builders Risk - Coverage - Building and Location Information", enabled = false, priority = 4) // HIDDEN FOR AGENTS
