package buildersRiskFLAgentTests;														// THIS TEST RUNS FOR 3 MINUTES AND 16 SECONDS
...
public class AgentAdditionalInterestsTest extends BuildersRiskBaseClass{
	...
	@Test(testName = "buildersRiskNewQuote", dataProvider = "NewConstructionData", description = "Builders Risk Start Quote Walkthrough to Add Interest/Insured page", enabled = true, priority = 0)
	public void buildersRiskNewQuote(String newquotestate, String newquotepolicytype, String newquoteaddress,
		...
		if(driver.findElement(By.id(loc.getProperty("builderscounty"))).getAttribute("type").equals("hidden")) {
			h = true;
	...
	@Test(testName = "buildersRiskInterests1", dataProvider = "NewConstructionData", description = "T18798	TC01 - Builders Risk - Additional Interest & Insured Headers", enabled = true, priority = 1)
	public void buildersRiskInterests1(String newquotestate, String newquotepolicytype,
	...
	@Test(testName = "buildersRiskInterests2",description = "T18799	TC02 - Builders Risk - Additional Interest", enabled = true, priority = 2)
	...
	@Test(testName = "buildersRiskInterests3", dataProvider = "NewConstructionData", description = "T18801	TC04 - Builders Risk - Additional Insureds", enabled = true, priority = 3)
	public void buildersRiskInterests3(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
