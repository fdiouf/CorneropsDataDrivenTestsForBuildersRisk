package buildersRiskFLAgentTests;														// THIS TEST RUNS FOR 1 MINUTES AND 52 SECONDS
...
//		driver.findElement(By.xpath(loc.getProperty("buildersterrorism"))).click();
	...
	@Test(dataProvider = "NewConstructionData", description = "T18813	TC04 - Builders Risk - Rating - Rating Variables", enabled = false, priority = 4) // FOR INTERNAL USERS ONLY
