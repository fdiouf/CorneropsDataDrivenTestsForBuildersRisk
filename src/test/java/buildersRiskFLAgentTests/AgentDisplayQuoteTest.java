package buildersRiskFLAgentTests;														// THIS TEST RUNS FOR 2 MINUTES AND 23 SECONDS
...
public class AgentDisplayQuoteTest extends BuildersRiskBaseClass {
	...
	@Test(dataProvider = "NewConstructionData", description = "Builders Risk Start Quote Walkthrough to Display Quote", enabled = true, priority = 0)
	...
	@Test(dataProvider = "NewConstructionData", description = "T18834	TC01 - Builders Risk - Display Quote Header", enabled = true, priority = 1)
	public void buildersRiskDisplayQuote1(String newquotestate, String newquotepolicytype,
	...
	@Test(description = "T18835	TC02 - Builders Risk - Display Quote - Quote Information", enabled = true, priority = 2)
	public void buildersRiskDisplayQuote2() throws InterruptedException{
	...
	@Test(dataProvider = "NewConstructionData", description = "T18837	TC04 - Builders Risk - Display Quote - Rating Variables", enabled = false, priority = 4) // ONLY FOR INTERNAL USERS
	public void buildersRiskDisplayQuote4(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
...
//		}
	...
	@Test(description = "T18838	TC05 - Builders Risk - Display Quote - Premium and Fees", enabled = true, priority = 5)
	public void buildersRiskDisplayQuote5() throws InterruptedException, ParseException{
	...
	@Test(description = "T18839	TC06 - Builders Risk - Display Quote - Underwriter", enabled = true, priority = 6)
	public void buildersRiskDisplayQuote6() throws InterruptedException{
		Boolean x = true;
		try {
		...
		Thread.sleep(2000);
		System.out.print("Display Quote Page is working correctly as expected\n");
	}
}
