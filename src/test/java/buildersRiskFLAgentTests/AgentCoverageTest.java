package buildersRiskFLAgentTests;														// THIS TEST RUNS FOR 1 MINUTES AND 54 SECONDS
...
public class AgentCoverageTest extends BuildersRiskBaseClass {
	...
	public void buildersRiskCoverage(String newquotestate, String newquotepolicytype,
	...
	public void buildersRiskCoverage2(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
	...
	public void buildersRiskCoverage3(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
	...
	@Test(dataProvider = "NewConstructionData", description = "T18806	TC04 - Builders Risk - Coverage - Building and Location Information", enabled = false , priority = 4) // THIS IS ONLY FOR INTERNAL USERS
	public void buildersRiskCoverage4(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
		...
		driver.findElement(By.id(loc.getProperty("builderscounty"))).click();
		if(!driver.findElement(By.xpath(loc.getProperty("builderslatitude"))).getAttribute("innerHTML").equals("  ")) {
			Assert.fail("EXPECTED LATITUDE TO BE HIDDEN FOR AGENTS");
		}
		if(!driver.findElement(By.xpath(loc.getProperty("builderslongitude"))).getAttribute("innerHTML").equals("  ")) {
			Assert.fail("EXPECTED LONGITUDE TO BE HIDDEN FOR AGENTS");
		}
		System.out.print("\nLattitude & Longitude hidden to agent as expected");
		Boolean checker = false;
		try {
			driver.findElement(By.id(loc.getProperty("builderswindpool"))).click();
		} catch (Exception e) {
			System.out.print("\nAgent does not have windpool field as expected");
			checker = true;
		}
		if(checker==false) {
			driver.findElement(By.id(loc.getProperty("builderswindpool"))).sendKeys("O");
//			Assert.fail("EXPECTED WINDPOOL TO BE HIDDEN FOR AGENT");---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		}
	}
	...
	public void buildersRiskCoverage5(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
...
//		}
	...
	public void buildersRiskCoverage6(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
		...
		try {
			...
			System.out.print("\nAgent does not have pc override field as expected");
			checker = true;
		}
		if(checker==false) {
			Assert.fail("EXPECTED PC OVERRIDE TO BE HIDDEN FOR AGENT");
		}
		checker = true;
		try {
			driver.findElement(By.id(loc.getProperty("buildersterritoryoverride"))).click();
		} catch (Exception e) {
			System.out.print("\nAgent does not have territory override field as expected");
			checker = false;
		}
		if(checker==true) {
			Assert.fail("EXPECTED TERRITORY OVERRIDE TO BE HIDDEN FOR AGENT");
		}
	}
	...
	public void buildersRiskCoverage7(String newquotestate, String newquotepolicytype,
			String newquoteaddress, String newquoteaddress2, String newquotecity, String newquotezipcode,
			String agentcode, String buildersprojecttype, String builderspolicyterm, String buildersapplicantphone,
			String buildersapplicantemail, String buildersapplicanttype, String buildersnametype,
			String buildersfirstname, String buildersmiddlename, String builderslastname, String builderssuffixname,
		...
		if(check == true) {
			Assert.fail("EXPECTED TERRORISM FIELD TO BE HIDDEN FOR AGENTS");
		}
		driver.findElement(By.xpath(loc.getProperty("buildersratingsbtn"))).click();
