package buildersRiskMisc;														// THIS TEST RUNS FOR 9 MINUTES AND 48 SECONDS
...
public class BuildersRiskUWCancelTest extends BuildersRiskBaseClass {
	...
	@Test(dataProvider = "MiscBRPolicy", description = "C10421	TC02 - Builders Risk - UW Cancel Notice", enabled = true, priority = 1)
	public void buildersRiskUWCancel(String newquotestate, String newquotepolicytype, String newquoteaddress,
...
//		driver.findElement(By.id(loc.getProperty("buildersclaimnumbers"))).click();
		...
		String nrdirectory = "";
		if(prop.getProperty("testurl").contains("stage")) {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\STAGE\\Cancellations\\cancellation";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/STAGE/Cancellations";
		}
		else {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\TEST\\Cancellations\\cancellation";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/TEST/Cancellations";
		}
		...
		String nrfilename = "/cancellation" + nrappender;
