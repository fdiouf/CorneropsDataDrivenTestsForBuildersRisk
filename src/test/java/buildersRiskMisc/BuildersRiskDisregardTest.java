package buildersRiskMisc;														// THIS TEST RUNS FOR 4 MINUTES AND 18 SECONDS
...
public class BuildersRiskDisregardTest extends BuildersRiskBaseClass{
	...
	@Test(dataProvider = "MiscBRPolicy", description = "C10424 TC05 - Builders Risk - Disregard Notice", enabled = true, priority = 1)
	public void buildersRiskDisregard(String newquotestate, String newquotepolicytype, String newquoteaddress,
...
//		driver.findElement(By.id(loc.getProperty("buildersclaimnumbers"))).click();
		...
		driver.findElement(By.linkText("Send UW Notice")).click();
		driver.switchTo().frame(0);
		driver.findElement(By.xpath("(//input[@name='ClearUWNotice'])[1]")).click();
		driver.findElement(By.xpath("(//input[@value='Go'])[1]")).click();
		Thread.sleep(500);
		try {
			driver.switchTo().alert().accept();
		...
		driver.findElement(By.linkText("Maintenance Jobs")).click();
		driver.switchTo().frame(0);
		driver.findElement(By.xpath("(//a[@title='Manually Add SatisfiedNotice Job'])[1]")).click();
		driver.findElement(By.name("JobEvalDate")).click();
		driver.findElement(By.name("JobEvalDate")).sendKeys(currentDateTime);
		driver.findElement(By.cssSelector("td:nth-child(3) > .RateDetailButton")).click();
		try {
		...
		driver.findElement(By.xpath("(//td[normalize-space()='Recission Notice'])[1]")).click();
		...
		String nrdirectory = "";
		if(prop.getProperty("testurl").contains("stage")) {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\STAGE\\DisregardNotices\\recission";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/STAGE/DisregardNotices";
		}
		else {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\TEST\\DisregardNotices\\recission";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/TEST/DisregardNotices";
		}
		...
		String nrfilename = "/recission" + nrappender;
