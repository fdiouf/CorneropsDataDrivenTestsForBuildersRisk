package buildersRiskMisc;														// THIS TEST RUNS FOR 7 MINUTES AND 18 SECONDS
...
public class BuildersRiskUWNoticeTest extends BuildersRiskBaseClass {
	...
	@Test(dataProvider = "MiscBRPolicy", description = "C10420	TC01 - Builders Risk - Nonrenewal Notice", enabled = true, priority = 1)
	public void buildersRiskUWNotice(String newquotestate, String newquotepolicytype, String newquoteaddress,
...
//		driver.findElement(By.id(loc.getProperty("buildersclaimnumbers"))).click();
		...
		String nrdirectory = "";
		if(prop.getProperty("testurl").contains("stage")) {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\STAGE\\UWNotices\\notice";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/STAGE/UWNotices";
		}
		else {
			nraddress = "C:\\TEMP\\BuildersRiskFiles\\TEST\\UWNotices\\notice";
			nrdirectory =  "file:///C:/TEMP/BuildersRiskFiles/TEST/UWNotices";
		}
		...
		String nrfilename = "/notice" + nrappender;
